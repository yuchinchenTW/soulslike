...
| Light attack | Sword And Shield Cross Slash | Adobe Mixamo |
...
Project adaptations: skeleton retargeting, scale normalization, palette and roughness adjustments, prop attachment, root-motion extraction, animation trimming, blending, and combat timing. `tools/build-character-clips.mjs` rebuilds the local animation libraries from the downloaded FBX clips and GLB rigs.
